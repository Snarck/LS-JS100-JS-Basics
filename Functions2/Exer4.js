...
It should take two parameters: someone's height (in cm) and weight (in kg). The formula for calculating the BMI is as follows:
...
//I got the same result, but by using a slightly different formula.  This is more succinct, though.
//Used the same toFixed. I just multiplied instead of divided. 
